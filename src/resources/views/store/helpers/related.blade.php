<div class="featured-product-area {{ request()->is('account') ? 'hide-nav' : ''}}">
    ...
    <div class="container">
        <div class="col-12">
            <div class="section-title">
                <h1>Related Products <span style="float: right;"> <a href="/items/search?category={{$product->mainCategory->slug}}">view more</a> </span>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="container container-scroll">
        ...
        <div class="row row-scroll">
            @foreach($array_related_products as $product)
